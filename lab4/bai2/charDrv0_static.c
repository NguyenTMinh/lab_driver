...
unsigned open_cnt = 0;
int static_dev_num = 8; // device number tu cap
...
static int __init char_driver_init(void)
{
	...
	dev_num = MKDEV(static_dev_num, 0);
	ret = register_chrdev_region(dev_num, 1, "tenDevice3.1");
	...
	device_create(device_class, NULL, dev_num, NULL,"lab4.2_NguyenTrongMinh");
